...
<center><div class="container" align="center">
	...
	if(mysql_num_rows($kq)>0) { //neu so dong cua csdl >0
		...
		<div class="sp">
            ...
            <div class="sub" align="center"><strong>Tên sản phẩm:</strong> <?php echo $d['TenSP'] ?></div>
            <div class="sub"><strong>Giá:</strong> <?php echo $d['Gia']?></div>
            <div class="mua"><a href="index.php?id=suasp&idloaisp=<?php echo $d['idSP']?>">Sửa</a>&nbsp;&nbsp;&nbsp;<a href="index.php?id=xoasp&idloaisp=<?php echo $d['idSP']?>">Xóa</a></div>
        </div>
		<?php }
	} 
	else { ?>
   ...
   if($p>1) { ?>
		<a href="index.php?p=<?php echo $p-1 ?>&nhomtrang=<?php echo $nhomtrang ?>&tsn=<?php echo $tsn ?>&dau=<?php echo $dau ?>&cuoi=<?php echo $cuoi ?>&nhom=<?php echo $nhom ?>"><<</a>
   <?php }
   ?>
   <?php
   for($i=$dau;$i<=$cuoi;$i++) {
   ...
   ?>
    <?php
   if($p<$tst) { ?>
		<a href="index.php?p=<?php echo $p+1 ?>&nhomtrang=<?php echo $nhomtrang ?>&tsn=<?php echo $tsn ?>&dau=<?php echo $dau ?>&cuoi=<?php echo $cuoi ?>">>></a>
   <?php }
   ?>
   </div>
</div></center>
